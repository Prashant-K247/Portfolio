...
const VelocityText: React.FC<VelocityTextProps> = ({
  ...
  return (
    <div className={`${parallaxClassName} relative overflow-hidden`} style={parallaxStyle}>
      <motion.div
        className={`${scrollerClassName} flex whitespace-nowrap humane text-center text-[154px] tracking-[0.3rem] drop-shadow md:leading-32`}
