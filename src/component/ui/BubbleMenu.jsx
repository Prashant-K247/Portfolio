      ...
      <nav className={containerClassName} style={style} aria-label="Main navigation">
        <a
          ...
          style={{
            ...
            boxShadow:
              "0 8px 30px rgba(255,255,255,.08), inset 0 1px 1px rgba(255,255,255,.25)",
          }}
        >
          {typeof logo === "string" ? (
            <img
              src={logo}
              alt="Logo"
              className="h-9 md:h-15 w-auto object-contain hover:scale-105 active:scale-95 transition-all duration-300"
              draggable={false}
            />
          ) : (
            logo
              ...
              >
                <a
                  ...
                  style={{
                    ...
                    minHeight: 'var(--pill-min-h, 110px)',
