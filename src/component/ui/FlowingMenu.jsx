...
function MenuItem({ link, text, subtitle, image, speed, textColor, marqueeBgColor, marqueeTextColor, borderColor, isFirst }) {
  ...
  return (
    ...
    >
        <div className="flex flex-col items-center">
          <span className="uppercase font-semibold text-[4vh]">
            {text}
          </span>
        
          <span className="mt-2 text-sm tracking-[0.25em] uppercase opacity-60">
            {subtitle}
          </span>
        </div>
      </Link>
